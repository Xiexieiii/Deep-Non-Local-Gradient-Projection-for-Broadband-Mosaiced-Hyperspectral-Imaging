...
- **Renwei Dian**: `drw@hnu.edu.cn`
- **Nan Wang**: `wangn@hnu.edu.cn`
- **Lishan Tan**: `LishanTan@hnu.edu.cn`
- **Shutao Li**: `shutao_li@hnu.edu.cn`

The corresponding author is **Renwei Dian**.
...
**Shutao Li, Yunyu Xie, Nan Wang, and Lishan Tan** are with:

- School of Artificial Intelligence and Robotics, Hunan University, Changsha 410082, China

## Paper Information

**Title:** Deep Non-Local Gradient Projection for Broadband Mosaiced Hyperspectral Imaging
